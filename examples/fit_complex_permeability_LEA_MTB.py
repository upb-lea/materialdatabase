...
def fit_complex_permeability_lea_mtb_example(mu_abs_flag: bool, pv_flag: bool,
    ...
    df_mat["pv"] = pv_mag(df_mat["f"].to_numpy(dtype=float),
...
if __name__ == '__main__':
    fit_complex_permeability_lea_mtb_example(mu_abs_flag=MU_ABS, pv_flag=PV, is_plot=True)
