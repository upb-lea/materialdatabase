...
class StyleDict(TypedDict, total=False):
    ...
    :param line_style: Line style for the plot (e.g., '-', '--', '-.')
    """
...
def plot_loss_vs_temperature(
    ax: Axes,
    df: pd.DataFrame,
    y_columns: Union[List[str], tuple],
    ...
    for y_col in y_columns:
        ...
        for key, group in df.groupby(["b", "f"]):
            ...
            ax.semilogy(
                T_vals, y_vals, ls=style["line_style"], color=style["color"], alpha=0.8
            )
...
def plot_loss_vs_flux_density(
    ...
    for y_col in y_columns:
        ...
        for key, group in df.groupby(["T", "f"]):
            ...
            ax.loglog(
                b_vals, y_vals, style["line_style"], color=style["color"], alpha=0.8
            )
...
def plot_mu_vs_frequency(
    ...
    for y_col in y_columns:
        ...
        for key, group in df.groupby(["b", "T"]):
            ...
            ax.plot(
                f_vals, y_vals, ls=style["line_style"], color=style["color"], alpha=0.8
            )
...
def plot_mu_vs_flux_density(
    ...
    for y_col in y_columns:
        ...
        for key, group in df.groupby(["T", "f"]):
            ...
            y_vals = sorted_group[y_col]
            ax.plot(
                b_vals, y_vals, ls=style["line_style"], color=style["color"], alpha=0.8
            )
