...
# database.get_material_property(material_name="N87", property="weight_density")
mdb.compare_permeability_measurement_data(material_list=["N87", "N95"], frequency=400000)
