...
def test_get_material_property():
    ...
    b_ref, mu_r_real, mu_r_imag = mdb_instance.permeability_data_to_pro_file(temperature=25, frequency=150000, material_name ="N95", datatype ="complex_permeability",
    ...
    epsilon_r, epsilon_phi_deg = mdb_instance.get_permittivity(temperature= 25, frequency=150000, material_name ="N95", datasource ="measurements",
...
def test_neighbourhood():
    correct_result_neighbourhood = {
        'T_low_f_low': {'temperature': {'value': 60, 'index': 0}, 'frequency': {'value': 300000, 'index': 2},
